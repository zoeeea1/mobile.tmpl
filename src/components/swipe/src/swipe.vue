<template>
  <div class="m-swipe">
    <div class="m-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="m-swipe-indicators" v-show="showIndicators">
      <div class="m-swipe-indicator"
        v-for="(page, $index) in pages" :key="$index" :class="{ 'is-active': $index === index }"></div>
    </div>
  </div>
</template>
