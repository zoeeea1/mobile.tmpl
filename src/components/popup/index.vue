<template>
        ...
        <transition :name="`vux-popup-animate-${position}`">
            <div v-show="show && !initialShow"  class="vux-popup-dialog">
                <div class="vux-popup-mask " :class="{'vux-popup-show': show}" @click="show=false"></div>
                <div :style="styles" class="vux-popup-dialog m-popup" :class="[`vux-popup-${position}`, show ? 'vux-popup-show' : '']">
                <slot></slot>
                </div>
            </div>
        </transition>
